        ...
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered>
          <div id="invoiceCapture">
            ...
            <div className="p-4">
              ...
              <Row className="mb-4">
                <Col md={4}>
                  <div className="fw-bold">Pay To Bank Name:</div>
                  <div>{this.props.info.payToBankName || ''}</div>
                </Col>
                <Col md={4}>
                  <div className="fw-bold">Pay To Account Name:</div>
                  <div>{this.props.info.payToAccountName || ''}</div>
                </Col>
                <Col md={4}>
                  <div className="fw-bold">Pay To Account Number:</div>
                  <div>{this.props.info.payToAccountNumber || ''}</div>
                </Col>
              </Row>
