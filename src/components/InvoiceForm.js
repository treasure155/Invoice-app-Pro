...
class InvoiceForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      payToBankName: '',        // New state property for Bank Name
      payToAccountName: '',     // New state property for Account Name
      payToAccountNumber: '',   // New state property for Account Number
      comment: '',              // New state property for Comment
    };
    this.state.items = [
      {
        id: 0,
          ...
          <Col md={8} lg={9}>
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Form.Group className="my-3">
                <Form.Label className="fw-bold">Pay To: Bank Name:</Form.Label>
                <Form.Control
                  name="payToBankName"
                  type="text"
                  value={this.state.payToBankName}
              ...
              <Form.Group className="my-3">
                ...
                <Form.Control
                  ...
                  type="text"
                  value={this.state.payToAccountName}
                  onChange={(event) => this.editField(event)}
              ...
              <Form.Group className="my-3">
                ...
                <Form.Control
                  ...
                  type="text"
                  value={this.state.payToAccountNumber}
                  onChange={(event) => this.editField(event)}
